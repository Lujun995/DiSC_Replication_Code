# modified from https://github.com/Sun-lab/ideas_pipeline/blob/main/COVID/1a_dca_recover_mean_norm.R
...
dca.dir = "/home/guanwh/zhan7474/mayo/ideas_pipeline-main/Autism/dca_PFC_all/"
data.dir = "/home/guanwh/zhan7474/mayo/ideas_pipeline-main/Autism/data/"

# Load the original count matrix used for DCA training

all_counts = read.csv(file.path(data.dir, "PFC_all.csv"), 
