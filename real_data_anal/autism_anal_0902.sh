...
#SBATCH -o /home/guanwh/zhan7474/mayo/real_data_anal/autism_anal_0902.out
#SBATCH -e /home/guanwh/zhan7474/mayo/real_data_anal/autism_anal_0902.err
#SBATCH -p msismall
#SBATCH -c 40
...
# singularity exec --bind /home/guanwh/zhan7474/mayo/ideas_pipeline-main/Autism/data:/container/input \
                 ...
                 # /home/guanwh/zhan7474/.local/bin/dca /container/input/PFC_all.csv /container/output/dca_PFC_all --threads 40 --type zinb-conddisp
...
Rscript /home/guanwh/zhan7474/mayo/real_data_anal/autism_anal_0902.R
